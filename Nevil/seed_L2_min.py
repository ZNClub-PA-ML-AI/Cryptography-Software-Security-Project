...
#    bpt=bin(pt) # prints 0b101101
    ...
    t=r
    r="{0:b}".format(int(l,2)^int(F(K(0),r),2))
    l=t
    r=make_64b(r)
    
    #last round
    
    l="{0:b}".format(int(l,2)^int(F(K(1),r),2))
    r=r
    #print("15",l,r)
...
PT="201620172018201920202021202220232024202"
KEY=""
